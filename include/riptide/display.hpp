...
namespace display {
    ...
    void update() {
        ...
        lv_label_set_text_fmt(leftMotorsDisplay[0], "mogoDist: %i ;; IMU: %i", (bot::mogoDist.get()), (int)(100 * bot::imu->get_rotation()));
        lv_label_set_text_fmt(rightMotorsDisplay[0], "rotSensor: %i", (int)(bot::horizTrackRotSensor->get_position() / 360.0 * 2.75 * M_PI));
